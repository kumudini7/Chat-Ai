...
const apiKey = "AIzaSyDzGmCkz6HJw_FSTEnkNlIiwEl8O2PUvjs";
function App() {
  ...
  // This is where JSX is returned
  return (
    <div className="fixed inset-0 bg-gradient-to-r from-blue-200 to-blue-400">
      <div className="h-full max-w-4xl mx-auto flex flex-col p-3">
        {/* Fixed Header */}
        <header className="text-center py-4">
          <a href="https://github.com/kumudini7/chat-ai" 
             target="_blank"
